// Generated by Haxe 3.3.0 (git build development @ 69237640)
...
doom_html_Render.prototype = {
		...
		while(tmp3.hasNext()) {
			...
			if(_g21 == null) {
				...
				case 0:
					...
					break;
				case 1:
					if(null == _g21[2] && key == "value") {
						doom_html_Attributes.setStringAttribute(dom,key,"");
					} else {
						var s = _g21[2];
						if(null == s || s == "" && key != "value") {
							doom_html_Attributes.removeAttribute(dom,key);
						} else {
					...
					break;
				case 2:
					doom_html_Render.setEvent(dom,key,_g21[2]);
					break;
				}
			}
		}
	...
	,createElement: function(name,attributes,children,post) {
		...
		if(colonPos > 0) {
			...
			if(null == ns) {
				throw new thx_Error("element prefix \"" + prefix + "\" is not associated to any namespace. Add the right namespace to Doom.namespaces.",null,{ fileName : "Render.hx", lineNumber : 369, className : "doom.html.Render", methodName : "createElement"});
			}
...
Main.main = function() {
	var store = lies_Store.create(function(state,action) {
		return { _0 : quiz_Reducers.quizApp(state,action), _1 : []};
	},quiz_State.Data(quiz_DataState.Needed));
	var app = new quiz_view_App({ state : store.state});
	store.subscribe(function(state1,_,_1) {
		app.update({ state : state1});
	});
	Doom.browser.mount(doom_core_VNodeImpl.Comp(app),window.document.querySelector("#app"));
};
Math.__name__ = ["Math"];
...
var quiz_Action = { __ename__ : ["quiz","Action"], __constructs__ : ["StartLoadingData","NextQuestion","AnswerQuestion"] };
quiz_Action.StartLoadingData = ["StartLoadingData",0];
quiz_Action.StartLoadingData.toString = $estr;
quiz_Action.StartLoadingData.__enum__ = quiz_Action;
quiz_Action.NextQuestion = ["NextQuestion",1];
quiz_Action.NextQuestion.toString = $estr;
quiz_Action.NextQuestion.__enum__ = quiz_Action;
quiz_Action.AnswerQuestion = ["AnswerQuestion",2];
quiz_Action.AnswerQuestion.toString = $estr;
quiz_Action.AnswerQuestion.__enum__ = quiz_Action;
var quiz_Reducers = function() { };
quiz_Reducers.__name__ = ["quiz","Reducers"];
quiz_Reducers.quizApp = function(state,action) {
	switch(action[1]) {
	case 0:
		return quiz_Reducers.fetchData(state);
	case 1:
		return quiz_Reducers.createQuestion(state);
	case 2:
		return quiz_Reducers.answerQuestion(state);
	}
};
quiz_Reducers.fetchData = function(state) {
	return state;
};
quiz_Reducers.createQuestion = function(state) {
	return state;
};
quiz_Reducers.answerQuestion = function(state) {
	return state;
};
var quiz_State = { __ename__ : ["quiz","State"], __constructs__ : ["Data","QuizMode"] };
quiz_State.Data = function(state) { var $x = ["Data",0,state]; $x.__enum__ = quiz_State; $x.toString = $estr; return $x; };
quiz_State.QuizMode = function(composers,question) { var $x = ["QuizMode",1,composers,question]; $x.__enum__ = quiz_State; $x.toString = $estr; return $x; };
var quiz_DataState = { __ename__ : ["quiz","DataState"], __constructs__ : ["Needed","Loading","Failed"] };
quiz_DataState.Needed = ["Needed",0];
quiz_DataState.Needed.toString = $estr;
quiz_DataState.Needed.__enum__ = quiz_DataState;
quiz_DataState.Loading = ["Loading",1];
quiz_DataState.Loading.toString = $estr;
quiz_DataState.Loading.__enum__ = quiz_DataState;
quiz_DataState.Failed = function(msg) { var $x = ["Failed",2,msg]; $x.__enum__ = quiz_DataState; $x.toString = $estr; return $x; };
var quiz_state_Question = { __ename__ : ["quiz","state","Question"], __constructs__ : ["RankComposers","CompositionYear"] };
quiz_state_Question.RankComposers = function(composers) { var $x = ["RankComposers",0,composers]; $x.__enum__ = quiz_state_Question; $x.toString = $estr; return $x; };
quiz_state_Question.CompositionYear = function(composition) { var $x = ["CompositionYear",1,composition]; $x.__enum__ = quiz_state_Question; $x.toString = $estr; return $x; };
var quiz_view_App = function(props,children) {
	doom_html_Component.call(this,props,children);
};
quiz_view_App.__name__ = ["quiz","view","App"];
quiz_view_App.__super__ = doom_html_Component;
quiz_view_App.prototype = $extend(doom_html_Component.prototype,{
	render: function() {
		...
		case 0:
			...
			switch(dataState[1]) {
			case 0:
				return doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("data needed")]));
			case 1:
				return doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("loading data")]));
			case 2:
				return doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text(dataState[2])]));
			}
			break;
		case 1:
			return doom_core__$VNode_VNode_$Impl_$.el("h1",null,doom_core__$VNodes_VNodes_$Impl_$.children([doom_core_VNodeImpl.Text("quizmode")]));
		}
	}
	,classes: function() {
		return "quiz_view_app";
	}
	,__class__: quiz_view_App
});
...
thx__$LocalDate_LocalDate_$Impl_$.fromTime = function(timestamp) {
	return (timestamp / 86400000. | 0) + 719162;
};
thx__$LocalDate_LocalDate_$Impl_$.fromString = function(s) {
	var _g = thx__$LocalDate_LocalDate_$Impl_$.parse(s);
	switch(_g[1]) {
	case 0:
		throw new thx_Error(_g[2],null,{ fileName : "LocalDate.hx", lineNumber : 52, className : "thx._LocalDate.LocalDate_Impl_", methodName : "fromString"});
		break;
	case 1:
		return _g[2];
	}
...
thx__$LocalDate_LocalDate_$Impl_$.parse = function(s) {
	if(s == null) {
		...
		if(!pattern.match(s)) {
			...
			return thx_Either.Right(pattern.matched(1) == "-"?-date:date);
		}
	}
};
...
thx__$LocalDate_LocalDate_$Impl_$.getDatePart = function(this1,part) {
	...
	var adays = y1 == 3 && (y4 != 24 || y100 == 3)?thx_DateConst.daysToMonth366:thx_DateConst.daysToMonth365;
	var m = n >> 6;
	while(n >= adays[m]) ++m;
	if(part == 2) {
		return m;
...
thx__$LocalDate_LocalDate_$Impl_$.snapNext = function(this1,period) {
	...
	case 3:
		return this1 + 1;
	case 4:
		return this1 + 7 - thx__$LocalDate_LocalDate_$Impl_$.get_dayOfWeek(this1);
	case 5:
...
thx__$LocalDate_LocalDate_$Impl_$.snapPrev = function(this1,period) {
	...
	case 0:case 1:case 2:case 3:
		return this1 - 1;
	case 4:
		return this1 - thx__$LocalDate_LocalDate_$Impl_$.get_dayOfWeek(this1);
	case 5:
...
thx__$LocalDate_LocalDate_$Impl_$.snapTo = function(this1,period) {
	...
	case 4:
		...
		return thx__$LocalDate_LocalDate_$Impl_$.create(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,0),thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,2),thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,3) + (wd <= 3?-wd:7 - wd));
	case 5:
		return thx__$LocalDate_LocalDate_$Impl_$.create(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,0),thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,2) + (thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,3) > Math.round(thx__$DateTimeUtc_DateTimeUtc_$Impl_$.daysInMonth(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,0),thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,2)) / 2)?1:0),1);
	case 6:
		return thx__$LocalDate_LocalDate_$Impl_$.create(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,0) + (this1 - thx__$LocalDate_LocalDate_$Impl_$.create(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(this1,0),6,2) > 0?1:0),1,1);
	}
};
...
thx__$LocalDate_LocalDate_$Impl_$.toString = function(this1) {
	...
	return (this1 < 0?"-":"") + ("" + thx__$LocalDate_LocalDate_$Impl_$.getDatePart(abs,0) + "-" + thx_Ints.lpad(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(abs,2),"0",2) + "-" + thx_Ints.lpad(thx__$LocalDate_LocalDate_$Impl_$.getDatePart(abs,3),"0",2));
};
...
thx__$LocalYearMonth_LocalYearMonth_$Impl_$.fromTime = function(timestamp) {
	var d = new Date();
	d.setTime(timestamp);
	return thx__$LocalYearMonth_LocalYearMonth_$Impl_$.fromDate(d);
};
thx__$LocalYearMonth_LocalYearMonth_$Impl_$.fromString = function(s) {
	...
	switch(_g[1]) {
	case 0:
		throw new thx_Error(_g[2],null,{ fileName : "LocalYearMonth.hx", lineNumber : 47, className : "thx._LocalYearMonth.LocalYearMonth_Impl_", methodName : "fromString"});
		break;
	case 1:
		return _g[2];
	}
...
thx__$LocalYearMonth_LocalYearMonth_$Impl_$.create = function(year,month) {
	return thx__$LocalYearMonth_LocalYearMonth_$Impl_$.dateToMonth(year,month);
};
...
thx__$Timestamp_Timestamp_$Impl_$.snapNext = function(this1,period) {
	...
	case 3:
		...
		d.setTime(this1);
		var d1 = d;
		return thx_Dates.create(d1.getFullYear(),d1.getMonth(),d1.getDate() + 1,0,0,0).getTime();
	case 4:
		var d2 = new Date();
		d2.setTime(this1);
		var d3 = d2;
		var wd = d3.getDay();
		return thx_Dates.create(d3.getFullYear(),d3.getMonth(),d3.getDate() + 7 - wd,0,0,0).getTime();
	case 5:
		var d4 = new Date();
		d4.setTime(this1);
		var d5 = d4;
		return thx_Dates.create(d5.getFullYear(),d5.getMonth() + 1,1,0,0,0).getTime();
	case 6:
		var d6 = new Date();
		d6.setTime(this1);
		return thx_Dates.create(d6.getFullYear() + 1,0,1,0,0,0).getTime();
	}
};
thx__$Timestamp_Timestamp_$Impl_$.snapPrev = function(this1,period) {
	...
	case 3:
		...
		d.setTime(this1);
		var d1 = d;
		return thx_Dates.create(d1.getFullYear(),d1.getMonth(),d1.getDate(),0,0,0).getTime();
	case 4:
		var d2 = new Date();
		d2.setTime(this1);
		var d3 = d2;
		var wd = d3.getDay();
		return thx_Dates.create(d3.getFullYear(),d3.getMonth(),d3.getDate() - wd,0,0,0).getTime();
	case 5:
		var d4 = new Date();
		d4.setTime(this1);
		var d5 = d4;
		return thx_Dates.create(d5.getFullYear(),d5.getMonth(),1,0,0,0).getTime();
	case 6:
		var d6 = new Date();
		d6.setTime(this1);
		return thx_Dates.create(d6.getFullYear(),0,1,0,0,0).getTime();
	}
};
thx__$Timestamp_Timestamp_$Impl_$.snapTo = function(this1,period) {
	...
	case 3:
		...
		d.setTime(this1);
		var d1 = d;
		var mod = d1.getHours() >= 12?1:0;
		return thx_Dates.create(d1.getFullYear(),d1.getMonth(),d1.getDate() + mod,0,0,0).getTime();
	case 4:
		var d2 = new Date();
		d2.setTime(this1);
		var d3 = d2;
		var wd = d3.getDay();
		var mod1 = wd < 3?-wd:wd > 3?7 - wd:d3.getHours() < 12?-wd:7 - wd;
		return thx_Dates.create(d3.getFullYear(),d3.getMonth(),d3.getDate() + mod1,0,0,0).getTime();
	case 5:
		var d4 = new Date();
		d4.setTime(this1);
		var d5 = d4;
		var mod2 = d5.getDate() > Math.round(DateTools.getMonthDays(d5) / 2)?1:0;
		return thx_Dates.create(d5.getFullYear(),d5.getMonth() + mod2,1,0,0,0).getTime();
	case 6:
		var d6 = new Date();
		d6.setTime(this1);
		var d7 = d6;
		var mod3 = this1 > new Date(d7.getFullYear(),6,2,0,0,0).getTime()?1:0;
		return thx_Dates.create(d7.getFullYear() + mod3,0,1,0,0,0).getTime();
	}
};
...
thx_promise__$Promise_Promise_$Impl_$.flatMapEither = function(this1,success,failure) {
	return thx_promise__$Promise_Promise_$Impl_$.createUnsafe(function(resolve,reject) {
		this1.then(function(result) {
			...
			case 0:
				try {
					thx_promise__$Promise_Promise_$Impl_$.either(failure(result[2]),resolve,reject);
				} catch( e ) {
					haxe_CallStack.lastException = e;
					if (e instanceof js__$Boot_HaxeError) e = e.val;
					reject(thx_Error.fromDynamic(e,{ fileName : "Promise.hx", lineNumber : 201, className : "thx.promise._Promise.Promise_Impl_", methodName : "flatMapEither"}));
				}
				break;
			case 1:
				try {
					thx_promise__$Promise_Promise_$Impl_$.either(success(result[2]),resolve,reject);
				} catch( e1 ) {
					haxe_CallStack.lastException = e1;
					if (e1 instanceof js__$Boot_HaxeError) e1 = e1.val;
					reject(thx_Error.fromDynamic(e1,{ fileName : "Promise.hx", lineNumber : 200, className : "thx.promise._Promise.Promise_Impl_", methodName : "flatMapEither"}));
				}
				break;
			}
		});
